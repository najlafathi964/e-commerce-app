...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    super.initState();
    selectedUrl = '${AppConstants.BASE_URI}/payment-mobile?customer_id=${widget.orderModel.userId}&order_id=${widget.orderModel.id}';
  ...
  void _redirect(String url) {
    print("redirect");
    if(_canRedirect) {
      bool _isSuccess = url.contains('success') && url.contains(AppConstants.BASE_URI);
      bool _isFailed = url.contains('fail') && url.contains(AppConstants.BASE_URI);
      bool _isCancel = url.contains('cancel') && url.contains(AppConstants.BASE_URI);
