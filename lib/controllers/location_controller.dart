...
import 'package:food_delivary_app/data/api/api_checker.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  //wither the user is in service zone
  bool _inZone = false;
  ...
  //     {required GoogleMapController mapController , LatLng? defultLatLng , bool notify = true}) async{
  //   _loading=true ;
  //   if(notify){
  //     update();
  //   }
  ...
  //   Position _test ;
  //
  //   Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.best) .then((value) => null);
  // }
